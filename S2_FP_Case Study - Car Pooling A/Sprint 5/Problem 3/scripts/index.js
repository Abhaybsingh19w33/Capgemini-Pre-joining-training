function validateUserName() {
    ...
    // let username = document."username"].value;
...
function validateForm() {
    let rideStartDate = document.getElementById("rideStartDate").value;
...
function validateSeatsRequired() {
    let noOfSeatsRequired = document.getElementById("noOfSeatsRequired").value;    
...
function onSubmit() {
    validateForm();
    let numberOfSeats = document.getElementById("noOfSeatsRequired").value;
    let rideCost= document.getElementById("rideCost").value;
    let username= document.getElementById("username").value;
